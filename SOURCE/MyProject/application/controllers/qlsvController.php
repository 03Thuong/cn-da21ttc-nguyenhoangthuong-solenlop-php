...
class qlsvController extends CI_Controller
{
    ...
    $data['nhommonhoc'] = $this->SinhVienModel->getNhomMonHoc();
    ...
    $this->load->view('admin/sinhvien/sinhvien', $data);
    ...
    public function edit($maSV)
    {
        ...
        if ($this->input->post()) {
            ...
            redirect(base_url('quanlysinhvien'));
        } else {
